...
@app.get("/new_emr", response_class=HTMLResponse)
async def show_new_emr_page(request: Request):
...
git remote add origin https://github.com/sgpeace/gugu_emr_main.git